...
public class DsWebServicesImpl extends BaseService {
    ...
    public ResponseResult getResult(String fileID) {
        ...
        try {
            ...
            // 计算图一图三所有结果并返回
            //处理graph12需要修改
            List<Pair<String, Integer>> graph12 = graphTool.getGraph12(syntenyNum, blocksListList, countNumList, synList);
            //获得图三
            ...
            result = new Result(blocksListList, animalNameList, countNumList, splitChoseAnimalName, graph12, graph3.getGraph3());
        } catch (IOException e) {
            e.printStackTrace();
